    ...
    <div className="h-[89.1vh] w-[63vh] bg-white p-8 text-base text-slate-900">
      ...
      <div className="mb-6 flex gap-8">
        <div className="shrink-0 grow-0 basis-[60%]">
          <h2 className="mb-2 text-7xl font-semibold text-accent">
            Shinjith P R
          </h2>
          ...
          <p className="text-xs text-slate-700">
            ...
            possibilities for skill development and significant contributions to
            ideas.
          </p>
        </div>
      ...
      <div className="flex gap-8">
        <div className="shrink-0 grow-0 basis-[60%]">
          ...
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">Experience</h4>
            <div>
              <Link
          ...
          {/* Education  */}
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">Education</h4>
            <div>
          ...
          {/* Projects  */}
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">Projects</h4>
            <div>
              <Link
              ...
              <p className="text-xs text-slate-700">
                ...
                platforms. Designed to improve productivity of completing task;
                with a classy themeable interface.
              </p>
            </div>
            <div>
              <Link
        ...
        <div>
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">Skills</h4>
            <div>
          ...
          {/* Soft skills  */}
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">Soft Skills</h4>
          ...
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">
              Language Proficiency
            </h4>
            <ul className="flex flex-col gap-1 text-sm font-medium text-slate-700">
              <li>
          ...
          {/* Interests  */}
          <div className="mb-5 space-y-4">
            <h4 className="font-semibold text-accent underline">Interests</h4>
